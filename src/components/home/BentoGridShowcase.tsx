...
export function BentoGridShowcase({ highlights, onSectionMount }: BentoGridShowcaseProps) {
  return (
    <section
      ...
      className="glass-depth w-full px-4 pb-24 pt-4 md:px-8 md:pb-36"
    >
  ...
  return (
    <ScrollReveal>
      <TransitionLink href={getHref(index)} className="group block">
        <GlassCard interactive radius="md" className="overflow-hidden">
          ...
          {/* Minimal caption inside the glass */}
          <div className="flex items-center justify-between gap-3 p-6 text-left">
            <div>
