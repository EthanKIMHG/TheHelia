...
import type { NavItem, NavSubItem, PreviewData, Locale } from "./types";
          ...
          >
                ...
                <div className="flex flex-col gap-2">
                  {activeNav.sub?.map((subItem) => {
                    ...
                    const matchesPreview =
                      ...
                      previewData.src === subItem.previewImage.src;
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-start md:gap-10">
              ...
              <div className="hidden w-[260px] shrink-0 flex-col items-center justify-center gap-3 md:flex">
                <div className="relative flex h-[300px] w-full flex-col overflow-hidden rounded-2xl border-[1px] border-border/20 bg-background">
                  {previewData ? (
                    <Image
                      src={previewData.src}
                      alt={previewData.alt}
